...
<script type="text/javascript">
	$(document).ready(function() {
		...
		function pollution(gu) {
			console.log(gu);

	      if(gu== "은평구"){$("#airimg").attr('src','./assets/img/airbad.png'); 
	      				console.log(gu);}
	      		
	      else if(gu== "금천구"){$("#airimg").attr('src','./assets/img/airbad.png'); 
	      				console.log(gu);}
	      		
	      else if(gu== "구로구"){$("#airimg").attr('src','./assets/img/airbad.png'); 
	      				console.log(gu);}
	      		
	      else if(gu== "종로구"){$("#airimg").attr('src','./assets/img/airgood.png'); 
	      				console.log(gu);}
	      		
	      else if(gu== "강북구"){$("#airimg").attr('src','./assets/img/airbad.png'); 
	      				console.log(gu);}
	      		
	      else if(gu== "중랑구"){$("#airimg").attr('src','./assets/img/airgood.png'); 
	      				console.log(gu);}
	      		
	      else if(gu== "강남구"){$("#airimg").attr('src','./assets/img/airbad.png'); 
	      				console.log(gu);}
	      		
	      else if(gu== "강동구"){$("#airimg").attr('src','./assets/img/airgood.png'); 
	      				console.log(gu);}
	      		
	      else if(gu== "중구"){$("#airimg").attr('src','./assets/img/airbad.png'); 
	      				console.log(gu);}
	      		
	      else if(gu== "광진구"){$("#airimg").attr('src','./assets/img/airgood.png'); 
	      				console.log(gu);}
	      		
	      else if(gu== "서초구"){$("#airimg").attr('src','./assets/img/airbad.png'); 
	      				console.log(gu);}
	      		
	      else if(gu== "성북구"){$("#airimg").attr('src','./assets/img/airgood.png'); 
	      				console.log(gu);}
	      		
	      else if(gu== "노원구"){$("#airimg").attr('src','./assets/img/airmid.png'); 
	      				console.log(gu);}
	      
	      else if(gu== "노원구"){$("#airimg").attr('src','./assets/img/airmid.png'); 
	      				console.log(gu);}
	      
	      else if(gu== "송파구"){$("#airimg").attr('src','./assets/img/airmid.png'); 
	      				console.log(gu);}
	      
	      else if(gu== "서대문구"){$("#airimg").attr('src','./assets/img/airmid.png'); 
	      				console.log(gu);}
	      
	      else if(gu== "양천구"){$("#airimg").attr('src','./assets/img/airmid.png'); 
	      				console.log(gu);}
	      
	      else if(gu== "영등포구"){$("#airimg").attr('src','./assets/img/airmid.png'); 
	      				console.log(gu);}
	      		
	      else{
	    	  $("#airimg").attr('src','./assets/img/airnone.png');
	      }	
		}
          ...
          <aside class="col-lg-6 order-lg-6">
              <div class="sidebar">
                <div class="block clearfix" id="houseInfo">
                  <h3 class="title">관심 지역 대기 오염 현황</h3>
