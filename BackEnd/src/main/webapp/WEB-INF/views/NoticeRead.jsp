...
<script type="text/javascript">
	$(document).ready(function() {
	    ...
	    $("#modify").click(function(){
	    	location.href="modifyNotice.html";
	    });
	});
</script>
<!-- Login JS End -->
...
<body>
	...
	<section id="services" class="services">
		...
		<div class="row justify-content-between">
			<button id="back" type="button" class="btn btn-primary" style="float:right">확인</button>
			<div class="justify-content-between" style="display:flex;width: 12rem">
				<button id="modify" type="button" class="btn btn-warning" style="float:right">수정하기</button>
				<button id="delete" type="button" class="btn btn-danger" style="float:right">삭제하기</button>
			</div>
		</div>
		</div>
	</section>
	<!-- ======= Footer ======= -->
	<footer id="footer" style="margin-top:138px">
