...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#enroll").click(function(){
			location.href = "enrollNotice.html";
		});
		...
		<div class="container">
			...
			<div class="row">
				<table class="table table-hover">
				    ...
				    <tbody id = "notice_check">
				      
				    </tbody>
				 </table>
			</div>
			
		<button id="enroll" type="button" class="btn btn-primary" style="float:right">등록</button>
		</div>
	</section>
	<!-- ======= Footer ======= -->
